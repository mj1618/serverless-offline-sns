...
import { IDebug, IServerless } from "./types.js";

export async function loadServerlessConfig(cwd = process.cwd(), debug: IDebug): Promise<IServerless> {
  ...
  return serverless as IServerless;
}
